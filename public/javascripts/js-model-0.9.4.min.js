...
Model.ClassMethods={unique_key:"id",add:function(){for(var a=[],b=0;b<arguments.length;b++){var c=arguments[b],d=c.id();if(jQuery.inArray(c,this.collection)===-1&&!(d&&this.find(d))){this.collection.push(c);a.push(c)}}a.length>0&&this.trigger("add",a);return this},all:function(){return this.collection.slice()},count:function(){return this.all().length},detect:function(a){for(var b=this.all(),c,d=0,i=b.length;d<i;d++){c=b[d];if(a.call(c,d))return c}},each:function(a){for(var b=this.all(),c=0,d=b.length;c<
d;c++)a.call(b[c],c);return this},find:function(a){return this.detect(function(){return this.id()==a})},first:function(){return this.all()[0]},load:function(a){if(this.persistence){var b=this;this.persistence.read(function(c){for(var d=0,i=c.length;d<i;d++)b.add(c[d]);a&&a.call(b,c)})}return this},last:function(){var a=this.all();return a[a.length-1]},map:function(a){for(var b=this.all(),c=[],d=0,i=b.length;d<i;d++)c.push(a.call(b[d],b[d],d));return c},pluck:function(a){for(var b=this.all(),c=[],
d=0,i=b.length;d<i;d++)c.push(b[d].attr(a));return c},remove:function(a){for(var b,c=0,d=this.collection.length;c<d;c++)if(this.collection[c]===a){b=c;break}if(b!=undefined){this.collection.splice(b,1);this.trigger("remove",[a]);return true}else return false},reverse:function(){return this.chain(this.all().reverse())},select:function(a){for(var b=this.all(),c=[],d,i=0,e=b.length;i<e;i++){d=b[i];a.call(d,i)&&c.push(d)}return this.chain(c)},sort:function(a){return this.chain(this.all().sort(a))},sortBy:function(a){var b=
jQuery.isFunction(a),c=function(d){return a.call(d)};return this.sort(function(d,i){d=b?c(d):d.attr(a);i=b?c(i):i.attr(a);return d<i?-1:d>i?1:0})}};Model.Errors=function(a){this.errors={};this.model=a};
